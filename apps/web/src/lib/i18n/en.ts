...
const en: Translations = {
  ...
  quiz: {
    ...
    assistantUnavailableYet: 'Rate this card first, then ask the AI.',
  },
  settings: {
    title: 'Settings',
    account: 'Account',
    ...
    themeDark: 'Dark',
    themeSystem: 'System',
    migration: 'Import Japanese words',
    ...
    saveQuizAiSessions: 'Save quiz AI conversations',
    saveQuizAiSessionsDesc: 'Off by default. When on, AI conversations during quiz sessions are saved to your assistant history.',
    prewarm: 'Pre-load AI model',
    prewarmDesc: 'Load the AI engine into memory on app start so the first response is fast. Adds ~250 MB of memory use.',
    telemetry: 'Share anonymous usage stats',
    telemetryDesc: 'Sends only anonymous counters (latency, tool counts) — never message content. Off by default.',
  },
  wordbooks: {
    title: 'Wordbooks',
  ...
  aiModel: {
    ...
    description: 'The on-device AI model extracts Japanese vocabulary from images. The model is stored on your device, runs fully offline, and never sends images externally.',
    status: 'Status',
    ...
    hide: 'Hide',
    etaPrefix: 'ETA ',
    downloadInProgressDescription: 'Downloading in the background — you can hide this; we will notify you when it finishes.',
    delete: 'Delete',
    deleteConfirm: 'Delete the stored AI model? You will need to re-download to use it again.',
    deleteSuccess: 'Model deleted.',
    downloadComplete: 'AI model is ready.',
    downloadFailed: 'Model download failed.',
    unsupportedDevice: 'This device does not have enough memory to run the AI model.',
    promptTitle: 'AI model required',
    promptDescriptionNeedsModel: 'To extract words from images, please download an AI model first. Pick one in Settings.',
    goToSettings: 'Go to settings',
    promptDismiss: 'Close',
    nativePoweredBy: 'Powered by Gemma 4 (Google)',
    appOnlyTitle: 'App-only feature',
    appOnlyDescription:
      'AI features are only available in the NiVoca iOS app. Please install the app from the App Store.',
    appOnlyOpenStore: 'Open App Store',
    variantSectionTitle: 'Choose a model',
    variantSelectActive: 'Select',
    variantSelected: 'Selected',
    variantActive: 'Currently active',
    variantSwitchConfirm:
      'Switch to this model? It will replace the currently active model.',
  ...
  assistant: {
    ...
    error: {
      generateFailed: 'Failed to generate a response. Please try again.',
      cancelled: 'Cancelled',
      modelMissing: 'AI model is not installed. Go to Settings → AI Model to download.',
      attachFailed: 'Could not attach file.',
      attachTooLarge: (sizeMb: number) => `Attachment too large (max ${sizeMb}MB)`,
      attachInvalidType: 'Only image or audio files can be attached.',
      tooManyAttachments: (max: number) => `You can attach at most ${max} files per message.`,
      micPermissionDenied: 'Microphone permission denied. Enable it in Settings.',
      recordFailed: 'Recording failed.',
      recordNotSupportedOnWeb: 'Recording is only available in the iOS app.',
    },
    ...
    feedbackThumbsUp: 'Good answer',
    feedbackThumbsDown: 'Bad answer',
    sessionsTitle: 'Chat history',
    sessionsLink: 'View past chats',
    sessionsEmpty: 'No saved conversations yet.',
    sessionsUntitled: 'Untitled',
    sessionsDeleteConfirm: 'Delete this conversation? Its messages will also be removed.',
    sessionsJustNow: 'now',
    sessionsMessageCount: (n: number) => `${n} message${n === 1 ? '' : 's'}`,
    summarizedNotice: (n: number) =>
      `${n} earlier message${n === 1 ? '' : 's'} summarized and included in context`,
  },
  aiStats: {
    title: 'AI Stats',
    usageSection: 'Usage',
    healthSection: 'Health',
    toolSection: 'Tool calls',
    ...
    localOnlyHint: 'These stats live on this device only and are never sent to a server.',
  },
};
